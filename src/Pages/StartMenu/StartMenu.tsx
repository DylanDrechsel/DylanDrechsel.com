...
const StartMenu: FC<StartMenuProps> = () => {
    ...
    const desiredCubeProps = [
        { x: -600, y: 0, letter: 'D', cubeSize: 200, fontSize: 8 },
        { x: -300, y: 25, letter: 'Y', cubeSize: 200, fontSize: 8 },
        { x: 0, y: 50, letter: 'L', cubeSize: 200, fontSize: 8 },
        { x: 300, y: 25, letter: 'A', cubeSize: 200, fontSize: 8 },
        { x: 600, y: 0, letter: 'N', cubeSize: 200, fontSize: 8 },
    ];

    const secondDesiredCubeProps = [
        { x: -625, y: 250, letter: 'D', cubeSize: 100, fontSize: 4 },
        { x: -450, y: 200, letter: 'R', cubeSize: 100, fontSize: 4 },
        { x: -275, y: 150, letter: 'E', cubeSize: 100, fontSize: 4 },
        { x: -100, y: 100, letter: 'C', cubeSize: 100, fontSize: 4 },
        { x:  100, y: 100, letter: 'H', cubeSize: 100, fontSize: 4 },
        { x:  275, y: 150, letter: 'S', cubeSize: 100, fontSize: 4 },
        { x:  450, y: 200, letter: 'E', cubeSize: 100, fontSize: 4 },
        { x:  625, y: 250, letter: 'L', cubeSize: 100, fontSize: 4 },
    ];
