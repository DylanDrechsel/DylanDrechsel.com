...
const StartMenu: FC<StartMenuProps> = () => {
    ...
    const secondDesiredCubeProps = [
        { x: -425, y: 250, letter: 'D', cubeSize: 100, fontSize: 4 },
        { x: -300, y: 200, letter: 'R', cubeSize: 100, fontSize: 4 },
        { x: -175, y: 150, letter: 'E', cubeSize: 100, fontSize: 4 },
        { x: -50, y: 100, letter: 'C', cubeSize: 100, fontSize: 4 },
        { x:  50, y: 100, letter: 'H', cubeSize: 100, fontSize: 4 },
        { x:  175, y: 150, letter: 'S', cubeSize: 100, fontSize: 4 },
        { x:  300, y: 200, letter: 'E', cubeSize: 100, fontSize: 4 },
        { x:  425, y: 250, letter: 'L', cubeSize: 100, fontSize: 4 },
    ];
